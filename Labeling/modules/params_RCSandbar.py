...
images_path = 'M:/Github/WRR_Segmentation_Data/Batch_image_processing/processed_imagery/rectified/' # change this to directory where rectified images are

root = 'M:/Github/WRR_Segmentation_Data/Labeling/label_output/' # CHANGE THIS TO LOCAL 'label_output'
# Images to do, it will cycle through these
done_im_pat =  root + 'images/'
# After images have a npy file made, they will be moved here move them
#   back to images_path if you would like to redo them
result_path = root + 'labels/'
# Where you want label image to go
compar_path = root + 'reports/'
# Where you want to comparison plots
matlab_path = root + 'reports/'
# Where you want to keep the matlab files
report_path = root + 'reports/'
# Where you want the reports
unsplit_pat = root + 'unsplit/'
# If the image is too big, it will be split up, where would you like to
# save the original?
den_lat_pat = root + 'files_npy/'
