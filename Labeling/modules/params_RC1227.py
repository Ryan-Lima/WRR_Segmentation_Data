...
"""
images_path = 'M:/GRCA_py_RCsandbar/Imagery/RC1227R/Stratified_sample/undistorted_images2020_9_17/registered_2020_9_18/rectified2020_9_20/'

# Images to do, it will cycle through these
done_im_pat = 'M:/GRCA_py_RCsandbar/Imagery/RC1227R/Stratified_sample/undistorted_images2020_9_17/registered_2020_9_18/images/'
# After images have a npy file made, they will be moved here move them
#   back to images_path if you would like to redo them
result_path = 'M:/GRCA_py_RCsandbar/Imagery/RC1227R/Stratified_sample/undistorted_images2020_9_17/registered_2020_9_18/labels/'
# Where you want label image to go
compar_path = 'M:/GRCA_py_RCsandbar/Imagery/RC1227R/Stratified_sample/undistorted_images2020_9_17/registered_2020_9_18/reports/'
# Where you want to comparison plots
matlab_path = 'M:/GRCA_py_RCsandbar/Imagery/RC1227R/Stratified_sample/undistorted_images2020_9_17/registered_2020_9_18/reports/'
# Where you want to keep the matlab files
report_path = 'M:/GRCA_py_RCsandbar/Imagery/RC1227R/Stratified_sample/undistorted_images2020_9_17/registered_2020_9_18/reports/'
# Where you want the reports
unsplit_pat = 'M:/GRCA_py_RCsandbar/Imagery/RC1227R/Stratified_sample/undistorted_images2020_9_17/registered_2020_9_18/unsplit/'
# If the image is too big, it will be split up, where would you like to
# save the original?
den_lat_pat = 'M:/GRCA_py_RCsandbar/Imagery/RC1227R/Stratified_sample/undistorted_images2020_9_17/registered_2020_9_18/files_npy/'
# If you choose to do the crf later where would you like the
# npy files saved?
image_types = [images_path + '*.JPG', images_path + '*.jpg',
...
## must be in this order for the final output to have sandbar as 1 and not_sandbar as 0
classes = {'Not_sandbar': '#FFFFFF',
            'Sandbar':'#FF0000'}
